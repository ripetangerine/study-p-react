...
export default function TodoList({todos, toggleTodo, deleteTodo}){ // todos는 여기서 사용하기에 냅둔 상태
    return( 
        <ul className="todo__list">
            ...
            {todos?.length === 0 && <TodoItemEmpty/>}
            {
                ...
                todos.map(
                    (todo)=> <TodoItem key={todo.id} todo={todo} toggleTodo={toggleTodo} deleteTodo={deleteTodo}/>
